...
<body class="font-sans text-gray-100 antialiased bg-dark-bg overflow-x-hidden">
    <div class="min-h-screen">
        ...
        <main class="relative overflow-x-hidden">
            ...
            <div class="absolute top-0 left-0 w-full h-96 bg-gradient-to-b from-primary-500/5 to-transparent -z-10">
            </div>
            <div
                class="absolute top-[-10%] right-[-5%] w-96 h-96 bg-primary-500/10 rounded-full mix-blend-screen filter blur-3xl opacity-30 -z-10">
            </div>
